...
export const projects = [
  {
    ...
    title: "Catch'n Match",
    description:
      "Catch’n Match is a fun web game that tests how fast and accurate you are. It has two levels — in Level 1, you match the correct static shape shown on the screen, and in Level 2, you catch the right falling shape within 5 seconds. The game includes a login system using JWT authentication, so players can join with their username. Built with React.js, Node.js, Express.js, MongoDB, and Framer Motion, it offers smooth animations and a clean, responsive design for an enjoyable playing experience.",
    imageUrl: "ss.png",
    projectUrl: "https://github.com/Shivam0884/Match-a-shape_game",
  },
  {
    id: 2,
    title: "WanderLust",
